...
{
    function test_updates_normal_items_before_sell_date()
    {
    ...
    function test_updates_normal_items_with_a_quality_of_0()
    {
    ...
    function test_updates_brie_items_before_the_sell_date_with_maximum_quality()
    {
    ...
    function test_updates_brie_items_on_the_sell_date_near_maximum_quality()
    {
    ...
    function test_updates_brie_items_on_the_sell_date_with_maximum_quality()
    {
    ...
    function test_updates_brie_items_after_the_sell_date_with_maximum_quality()
    {
    ...
    function test_updates_backstage_pass_items_long_before_the_sell_date()
    {
        $item = GildedRose::of(
    ...
    function test_updates_backstage_pass_items_close_to_the_sell_date()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            10,
    ...
    function test_updates_backstage_pass_items_close_to_the_sell_data_at_max_quality()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            50,
    ...
    function test_updates_backstage_pass_items_very_close_to_the_sell_date()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            10,
    ...
    function test_updates_backstage_pass_items_very_close_to_the_sell_date_at_max_quality()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            50,
    ...
    function test_updates_backstage_pass_items_with_one_day_left_to_sell()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            10,
    ...
    function test_updates_backstage_pass_items_with_one_day_left_to_sell_at_max_quality()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            50,
    ...
    function test_updates_backstage_pass_items_on_the_sell_date()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            10,
    ...
    function test_updates_backstage_pass_items_after_the_sell_date()
    {
        $item = GildedRose::of(
            'Backstage passes to a TAFKAL80ETC concert',
            10,
    ...
    function test_updates_conjured_items_at_zero_quality()
    {
    ...
    function test_updates_conjured_items_on_the_sell_date_at_0_quality()
    {
    ...
    function test_updates_conjured_items_after_the_sell_date_at_zero_quality()
    {
        $item = GildedRose::of('Conjured Mana Cake', 0, -10);
